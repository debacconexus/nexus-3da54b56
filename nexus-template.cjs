...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "California Maternal Mortality Surveillance Network";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "maternal_mortality_case";
process.env.TABLE_NAME = process.env.TABLE_NAME || "maternal_mortality_case_records";
'use strict';
